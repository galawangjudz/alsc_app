...
class BuyersAccountBuyersModel extends Model
{
    ...
    public static function getByAccountId($accountId)
    {
        ...
        $stmt = $instance->db->prepare("SELECT * FROM buyers_account_buyers WHERE buyers_account_id = ?");
    ...
    public static function deleteByAccountId($accountId)
    {
        ...
        $stmt = $instance->db->prepare("DELETE FROM buyers_account_buyers WHERE buyers_account_id = ?");
